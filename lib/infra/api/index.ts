...
export class Api extends Construct {
    ...
    private createChatResources(api: apigw.RestApi, props: ApiProps): lambda.Function {
        ...
        // Grant S3 permissions to access input assets bucket
        if (props.baseInfra.inputAssetsBucket) {
            props.baseInfra.inputAssetsBucket.grantRead(chatApiHandler);
        }
    ...
    private createInferenceResources(
        ...
        const inferenceLambda = this.createLambdaHandler('inference', props, {
            ...
            LINKS_TABLE_NAME: props.baseInfra.linksTable.tableName,
            /* eslint-enable @typescript-eslint/naming-convention */
        });

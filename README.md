...
- [Francis GenAI RAG ChatBot by AWS](#francis-genai-rag-chatbot-on-aws)
...
Please check the file names [scp-allow-required-services.json](scp-allow-required-services.json)
...
Execute the following command in terminal. For more information check [here](https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/setting-up-node-on-ec2-instance.html)
...
If you are accessing this code as a private repository you also need to setup SSH Keys. For information to check about existing keys [click here](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys) & for creating new keys [click here](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)
...
Execute the following command in terminal. For more information check [here](https://docs.aws.amazon.com/cdk/v2/guide/getting-started.html)
...
Execute the following command in terminal. For more information check [here](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/install-docker.html)
...
- Taran Singh, Software Development Engineer Intern - <tsingh33@calpoly.edu>
